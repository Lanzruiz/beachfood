...
class UpdateCouponCode extends React.Component {
    ...
    componentDidMount(){
        ...
        couponCodeRef.child(couponID).once('value', function(snapshot) {
            let couponRec = snapshot.val();
            _ths.setState({
               name: couponRec.name,
               code: couponRec.code,
               discount_in_dollar: couponRec.discount_in_dollar,
               discount_in_percentage: couponRec.discount_in_percentage,
               activation_date: couponRec.activation_date,
               expiration_date: couponRec.expiration_date,
               couponKey: couponID
            })
        });
    ...
    saveCouponCode(){
        ...
        if(errorFields == false) {
          ...
          couponCodeRef.child(_ths.state.couponKey).update(value);
...
UpdateCouponCode.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(UpdateCouponCode);
